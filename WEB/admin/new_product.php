...
<body>
    ...
    $(document).ready(function() {
        ...
        document.getElementById('addDetailField').addEventListener('click', function() {
            const detailsContainer = document.getElementById('productDetails');
            const newDetailField = document.createElement('div');
            newDetailField.className = 'mb-3 row';
            newDetailField.innerHTML = `
                <div class="col">
                    <input type="text" class="form-control" name="detailName[]" placeholder="Detail name">
                </div>
                <div class="col">
            ...
            `;
            detailsContainer.appendChild(newDetailField);
        });
