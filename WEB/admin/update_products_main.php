    ...
    <div class="row">
        ...
        <div class="navigation col-md-3 col-lg-3 d-none d-md-flex flex-column p-3 bg-body-tertiary" style="width: 280px; min-height:100vh;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li><a href="#" class="nav-link active link-body-emphasis">Update Products from JSON</a></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light d-md-none">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item"><a href="#" class="nav-link active link-body-emphasis">Update Products from JSON</a></li>
